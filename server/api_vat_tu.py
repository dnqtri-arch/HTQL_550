...
Hình ảnh lưu tại: /ssd_2tb/HTQL_550/thietke/vattu/ — Database chỉ lưu tên file.
"""
...
from cau_hinh import DUONG_DAN_VAT_TU, tao_thu_muc_vat_tu
...
def tao_ung_dung():
    ...
    def tai_len_hinh_anh():
        """Tải lên hình ảnh vật tư. Lưu vào /ssd_2tb/HTQL_550/thietke/vattu/. DB chỉ lưu tên file."""
