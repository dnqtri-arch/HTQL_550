...
export function VatTuHangHoaFormTabNgamDinh({
  ...
  return (
    <div className="misa-form-grid htql-tab-grid htql-tab-ngam-dinh" onKeyDown={handleEnterNav}>
      ...
      {/* Row 5 — Left: TK giảm giá | Right: Là vật tư, hàng hóa bán (task 7: chỉ hiện khi Tính chất = Vật tư) */}
      ...
      <div
        ...
        style={{
          ...
          visibility: tinhChat === 'Vật tư' ? 'visible' : 'hidden',
        }}
      >
      ...
      {/* Row 6 — Left: TK chi phí | Right: Là hàng khuyến mãi */}
