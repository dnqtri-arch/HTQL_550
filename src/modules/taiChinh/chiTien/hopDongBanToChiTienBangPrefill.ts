...
import { tinhDaThuVaConLaiChoHopDongBan } from './chungTuCongNoChiTien'
...
export function buildChiTienBangPrefillFromHopDongBanChungTu(
  ...
  const prefillDon: Partial<ChiTienBangRecord> = {
    ...
    tinh_trang: 'Mới tạo',
    ngay_chi_tien_bang: row.ngay_lap_hop_dong,
...
export function buildChiTienBangPrefillFromPhuLucHopDongBan(
  row: PhuLucHopDongBanChungTuRecord,
  chiTiet: PhuLucHopDongBanChungTuChiTiet[],
): { prefillDon: Partial<ChiTienBangRecord>; prefillChiTiet: ChiTienBangChiTiet[] } {
  return buildChiTienBangPrefillFromHopDongBanChungTu(row as unknown as HopDongBanChungTuRecord, chiTiet as unknown as HopDongBanChungTuChiTiet[])
}
