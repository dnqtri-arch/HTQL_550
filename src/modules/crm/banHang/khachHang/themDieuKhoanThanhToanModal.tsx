...
import type { DieuKhoanThanhToanKhItem } from './khachHangApi'
...
interface ThemDieuKhoanThanhToanModalProps {
  onClose: () => void
  onSave: (item: DieuKhoanThanhToanKhItem) => void
  onSaveAndAdd?: (item: DieuKhoanThanhToanKhItem) => void
  /** Danh sách hiện có để kiểm tra trùng mã */
  existingItems?: DieuKhoanThanhToanKhItem[]
}
...
export function ThemDieuKhoanThanhToanModal({
  ...
  const handleCất = () => {
    ...
    const item: DieuKhoanThanhToanKhItem = {
      ma: maTrim,
      ten: tenTrim,
