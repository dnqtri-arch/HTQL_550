...
export interface NhomKhNccInlinePickerProps {
  open: boolean
...
export function NhomKhNccInlinePicker({
  open,
  anchorRef,
  items: itemsProp,
  value,
  ...
  const toggleRow = (ten: string) => {
    setSelectedTens((prev) => {
      ...
      onLiveSelectionChange?.(Array.from(next))
      return next
    })
  }
