...
import { DonHangMua } from '../don-hang-mua/DonHangMua'
import { NhanVatTuHangHoa } from '../../inventory/nhan-vat-tu-hang-hoa/NhanVatTuHangHoa'
import {
  type DonHangMuaChiTiet,
  type DonHangMuaRecord,
  donHangMuaSetTinhTrang,
  TINH_TRANG_DON_HANG_MUA_DA_NHAN_HANG,
} from '../don-hang-mua/donHangMuaApi'
import {
...
const TABS_MUA_HANG = [
  { id: 'don-hang-mua', label: 'Đơn hàng mua' },
  { id: 'nhan-vat-tu-hang-hoa', label: 'Nhận vật tư hàng hóa' },
...
export function MuaHang() {
  const [tabHienTai, setTabHienTai] = useState('don-hang-mua')
  ...
  const noiDungTab = () => {
    ...
    if (tabHienTai === 'nhan-vat-tu-hang-hoa') {
      return (
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
          <NhanVatTuHangHoa
