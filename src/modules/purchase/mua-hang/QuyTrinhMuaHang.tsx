...
const NODES_ROW1 = [
  { id: 'don-hang-mua', label: 'Đơn hàng mua', Icon: FileText, x: ROW_ORIGIN_X + 0 * (NODE_W + COL_GAP) },
  { id: 'nhan-vat-tu-hang-hoa', label: 'Nhận vật tư', label2: 'hàng hóa', Icon: Package, x: ROW_ORIGIN_X + 1 * (NODE_W + COL_GAP) },
...
export function QuyTrinhMuaHang({
  ...
  const handleClickNode = (nodeId: string) => {
    const tabMap: Record<string, string> = {
      'don-hang-mua': 'don-hang-mua',
      'nhan-vat-tu-hang-hoa': 'nhan-vat-tu-hang-hoa',
